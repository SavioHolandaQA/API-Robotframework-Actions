...
Step 6: Atualizar a reserva com o token
    ${updated_dates}=    Create Dictionary    checkin=2018-01-01    checkout=2019-01-01
    ${updated_data}=    Create Dictionary    firstname=Sávio    lastname=QA    totalprice=520    depositpaid=True    bookingdates=${updated_dates}    additionalneeds=Breakfast
